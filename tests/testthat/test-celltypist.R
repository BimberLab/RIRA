...
test_that("celltypist runs for RIRA models", {
  ...
  expect_equal(688, unname(table(seuratObj$RIRA_TNK_v2.predicted_labels)['CD4+ T Cells']), tolerance = 1)
  expect_equal(745, unname(table(seuratObj$RIRA_TNK_v2.predicted_labels)['CD8+ T Cells']), tolerance = 1)
  expect_equal(74, unname(table(seuratObj$RIRA_TNK_v2.predicted_labels)['Gamma/Delta Cells']), tolerance = 1)
  expect_equal(1193, unname(table(seuratObj$RIRA_TNK_v2.predicted_labels)['NK Cells']), tolerance = 1)
