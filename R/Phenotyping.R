...
PlotImmuneMarkers <- function(seuratObj, reductions = c('tsne', 'umap')) {
	...
	PlotMarkerSet(seuratObj, reductions = reductions, 'Platelet/MK', features = c('ITGB3', 'PPBP', 'LOC703451'))
...
humanRibosomalGenes <- readRDS(system.file("humanRibosomalGenes_Human_GRCh38_p13_Ensembl.rds", package = "RIRA"))
