...
PlotImmuneMarkers <- function(seuratObj, reductions = c('tsne', 'umap')) {
  ...
  # MRC1 = CD206
	...
	PlotMarkerSeries(seuratObj, reductions = reductions, features = c(GetGeneSet('TNK_MaybeExhaustion'), 'CD44', 'AHNAK', 'CX3CR1', 'CD38'), 'T/NK: Possibly Antigen-Exposure/Exhaustion')
    ...
    # IL7R = CD127
    PlotMarkerSeries(seuratObj, reductions = reductions, features = c('CD44', 'CX3CR1', 'CD69', 'KLRG1', 'IL7R', 'CXCR3'), 'Resident Memory 2')
...
#' @title RegisterGeneSet
#'
#' @description Registers a named gene set in the package gene-set registry.
...
RegisterGeneSet("EC_Ribosomal", c('LOC114679282','LOC720132','LY6E','RPL17','RPL41','LOC719250','LOC704510','LOC706532','LOC717289','LOC695670','LOC693287','LOC10699357'))
...
RegisterGeneSet('MHC-II', c('IFI30', 'CD74', 'MAMU-DRB1', 'MAMU-DRA', 'MAMU-DQA1','MAMU-DRB5','CST3'))
