...
#'
#' @export
FilterDisallowedClasses <- function(seuratObj, sourceField = 'RIRA_Immune_v1.majority_voting', ucellCutoff = 0.2, disallowedClasses = list(
  ...
  allCells <- arrange(allCells, sortOrder)
